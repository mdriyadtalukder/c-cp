...
{
    int n = mat.size();
    if (r < 0 || c < 0 || r >= n || c >= n || mat[r][c] == 0 || vis[r][c] == true) // mat[r][c]==-1.. // true hoyle vis cell and cell gula 0 theke choto ba n er theke boro hyle.
    {
        return;
    }
    if (r == n - 1 && c == n - 1)
    ...
    vis[r][c] = false; // //mat[r][c]=1// backtracking
}
